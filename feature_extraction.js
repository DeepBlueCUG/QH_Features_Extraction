...
// 装入模块
var data_prepocess = require('users/rsliuxk/Agrors_Classify:data_preprocess_190219');
var harmonic_analysis = require('users/rsliuxk/Agrors_Classify:harmonic_analysis_190219');

var phenology_prepocess = require('users/rsliuxk/Agrors_Classify:phenology_prepocess'); // NDVI预处理模块
var multispectral_prepocess = require('users/rsliuxk/Agrors_Classify:multispectral_prepocess'); // Landsat预处理模块
var radar_prepocess = require('users/rsliuxk/Agrors_Classify:radar_prepocess'); //  哨兵数据预处理模块
var reveal = require('users/rsliuxk/Agrors_Classify:reveal_model'); // 可视化模块 
var coefficient = require('users/rsliuxk/Agrors_Classify:addbands_coefficient'); // 添加系数波段模块
var fitting = require('users/rsliuxk/Agrors_Classify:fitting_data'); // 添加数据拟合模块
var phenology_characters = require('users/rsliuxk/Agrors_Classify:phenology_characters'); // 添加提取物候特征波段模块
var multispectral_characters = require('users/rsliuxk/Agrors_Classify:multispectral_characters'); // 添加提取多光谱波段模块
var radar_characters = require('users/rsliuxk/Agrors_Classify:radar_characters'); // 添加提取后向散射系数特征波段模块
var postprocess = require('users/rsliuxk/Agrors_Classify:postpocess'); // 添加后处理模块 
...
Export.image.toAsset({
  image: characters,
  description: 'qh_feature_0322',
  assetId: 'QH/qh_feature_0322',
  scale: 30,
  region: boundary,
  maxPixels: 1.5e9
});
